...
PAGES = [('index', 'الرئيسية'), ('services', 'الخدمات'), ('offerings', 'التقديمات والمعدات'),
         ...
         ('qahwajiin-riyadh', 'قهوجيين الرياض'), ('diyafa-munasabat-makkah', 'ضيافة مناسبات مكة'), ('mubashirin-qahwa-jeddah', 'مباشرين قهوة جدة'), ('qahwajiin-jeddah', 'قهوجيين جدة — النموذج v6.8')]
